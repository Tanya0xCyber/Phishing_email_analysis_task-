...
<p align="center">
  <img src="C:\Users\tanya singh\OneDrive\Pictures\Screenshots" width="80%">
</p>
...
- **Screenshot:** `Insert screenshot of sender email here`  
...
- **Screenshot:** `Insert screenshot of header analysis here`  
...
- **Screenshot:** `Insert screenshot of hovering over link here`  
...
- **Screenshot:** `Highlight urgent language in the email here`  
...
- **Screenshot:** `Optional: highlight any grammar/spelling errors`  
...
- Hover over links and analyze headers before interacting.
